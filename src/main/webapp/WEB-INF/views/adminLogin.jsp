...
<html lang="en">
<head>
	<title>Admin Login-Loyalty Contest</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('resources/Login/images/bg-01.jpg');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<h4>Loyalty Contest Admin Login</h4>
				<form action="adminlogin" method="post" class="login100-form validate-form flex-sb flex-w">
